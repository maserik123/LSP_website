...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2><span class="fa fa-table"></span> Data Asesor Sertifikasi LSP </h2>
                        ...
                        <table id="data" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th style="font-size: 11px;">Hapus</th> -->
                                    ...
                                    <th style="font-size: 11px;">Nomor Hp</th>
                                    <th style="font-size: 11px;">Nomor Telepon</th>
                                    <th style="font-size: 11px;">Email</th>
                                    <th style="font-size: 11px;">Kode Pos</th>
                                    <th style="font-size: 11px;">Telp Kantor</th>
                                    <th style="font-size: 11px;">Pendidikan Terakhir</th>
                                    <th style="font-size: 11px;">Lembaga Pekerjaan</th>
                                    ...
                                    <th style="font-size: 11px;">Fax Perusahaan</th>
                                    <th style="font-size: 11px;">No Telepon Perusahaan</th>
