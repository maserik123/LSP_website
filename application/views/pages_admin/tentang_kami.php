<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            // ],
            "ajax": {
                "url": "<?php echo site_url('administrator/tentang_kami/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function ubah(id) {
        ...
        $('.form-group').removeClass('has-error')
            ...
            .find('#text-error').remove();
        $.ajax({
            url: "<?php echo site_url('administrator/tentang_kami/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function hapus(id) {
        swal({
            ...
            function() {
                $.ajax({
                    url: "<?php echo site_url('administrator/tentang_kami/delete'); ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function simpan() {
        ...
        var url;
        if (save_method == 'add') {
            url = '<?php echo base_url() ?>administrator/tentang_kami/addData';
        } else {
            url = '<?php echo base_url() ?>administrator/tentang_kami/update';
        }
        swal({
...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2><span class="fa fa-table"></span> Tentang Kami </h2>
            <ul class="nav navbar-right panel_toolbox">
                <?php if (!empty($getData[0]->isi)) {
                } else { ?>
                        ...
                        <table id="data" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 11px;">Judul</th>
                                    <th style="font-size: 11px;">Tentang LSP PCR</th>
                ...
                <dv class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Judul<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <input type="text" name="judul" id="judul" class="form-control has-feedback-left">
                                <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                            </div>
                        </div>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Isi Tentang Kami<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
