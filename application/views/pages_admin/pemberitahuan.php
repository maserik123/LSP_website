<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            // ],
            "ajax": {
                "url": "<?php echo site_url('administrator/pemberitahuan/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function ubah(id) {
        ...
        $('.form-group').removeClass('has-error')
            ...
            .find('#text-error').remove();
        $.ajax({
            url: "<?php echo site_url('administrator/pemberitahuan/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(resp) {
                data = resp.data
                $('[name="id"]').val(data.id);
                $('[name="pemberitahuan"]').val(data.pemberitahuan);
    ...
    function hapus(id) {
        swal({
            ...
            function() {
                $.ajax({
                    url: "<?php echo site_url('administrator/pemberitahuan/delete'); ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function simpan() {
        ...
        var url;
        if (save_method == 'add') {
            url = '<?php echo base_url() ?>administrator/pemberitahuan/addData';
        } else {
            url = '<?php echo base_url() ?>administrator/pemberitahuan/update';
        }
        swal({
...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2><span class="fa fa-table"></span> Data Pemberitahuan </h2>
                        ...
                        <table id="data" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 11px;">Pemberitahuan</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pemberitahuan Asesi</h5>
                ...
                <dv class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Pemberitahuan<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <textarea name="pemberitahuan" id="pemberitahuan" class="form-control" rows="5"></textarea>
                            </div>
                        </div>
