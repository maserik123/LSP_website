<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            // ],
            "ajax": {
                "url": "<?php echo site_url('administrator/jadwal/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function ubah(id) {
        ...
        $('.form-group').removeClass('has-error')
            ...
            .find('#text-error').remove();
        $.ajax({
            url: "<?php echo site_url('administrator/jadwal/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(resp) {
                ...
                $('[name="mulai_daftar"]').val(data.mulai_daftar);
                $('[name="akhir_daftar"]').val(data.akhir_daftar);
    ...
    function hapus(id) {
        swal({
            ...
            function() {
                $.ajax({
                    url: "<?php echo site_url('administrator/jadwal/delete'); ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function simpan() {
        ...
        var url;
        if (save_method == 'add') {
            url = '<?php echo base_url() ?>administrator/jadwal/addData';
        } else {
            url = '<?php echo base_url() ?>administrator/jadwal/update';
        }
        swal({
...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2><span class="fa fa-table"></span> Data Jadwal Pendaftaran </h2>
                ...
                <dv class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Nama Skema<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <!-- <input type="text" name="id_skema" id="id_skema" class="form-control has-feedback-left"> -->
                        ...
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Buka Pendaftaran<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <input type="date" name="mulai_daftar" id="mulai_daftar" class="form-control has-feedback-left datepicker">
                                <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                            </div>
                        </div>
                        <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Tutup Pendaftaran<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <input type="date" name="akhir_daftar" id="akhir_daftar" class="form-control has-feedback-left">
                                <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                            </div>
                        </div>
                        <!-- <div class="field item form-group">
                            <label class="col-form-label col-md-4 col-sm-3">Tanggal Pelaksanaan<span class="required">*</span></label>
                            <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                <input type="date" name="tanggal_pelaksanaan" id="tanggal_pelaksanaan" class="form-control has-feedback-left">
                                <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                            </div>
                        </div> -->
                    </div>
