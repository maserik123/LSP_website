<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        table = $('#data').DataTable({
            ...
            // ],
            "ajax": {
                "url": "<?php echo site_url('administrator/konfirmasi_apl02/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function ubah(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('administrator/konfirmasi_apl02/getById/'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function detail(id) {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                // $('[name="nik_lsp"]').val(data.nik_lsp);
                // $('[name="tanda_tangan_admin"]').val(data.tanda_tangan_admin);
                $('[name="detail_keterangan_status"]').html(data.keterangan_status);
                $('[name="detail_status_diterima"]').val(data.status_diterima);
                $('.reset').hide();
            },
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Error Get Data From Ajax');
    ...
    function cetakPermohonanAsesi(id) {
        window.open('<?php echo base_url('administrator/cetakPermohonanAsesi/') ?>' + id, '_blank');
    }
</script>
    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li><button class="btn btn-sm btn-primary" onclick="window.location ='<?php echo base_url('administrator/downloadDataAsesi') ?>'" style="font-size: 12px;">
                        <span class="fa fa-arrow-right"></span> Unduh dokumen disini</button></li>
            </ul>
                    ...
                    <div id="form_1">
                        <div class="col-md-12">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                    <input type="text" value="<?php echo $cekDataByIdUser[0]->nama_lengkap; ?>" class="form-control has-feedback-left" readonly>
                                    <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                                </div>
                            </div>
                            <div class="field item form-group">
                                ...
                                <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                    <input type="text" name="nik_lsp" id="nik_lsp" value="564-ID" class="form-control has-feedback-left" readonly>
                                    <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-8 xdisplay_inputx form-group row has-feedback">
                                    ...
                                    <input type="hidden" name="tanggal_diterima" id="tanggal_diterima" value="<?php echo date('Y-m-d')  ?>" class="form-control has-feedback-left" readonly>
                                    <!-- <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span> -->
                                </div>
                            </div>
                        </div>
