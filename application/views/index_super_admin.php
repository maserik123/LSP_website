    ...
    <div class="container body">
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view" style="background-color:darkslategray;">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?php echo base_url('superAdmin') ?>" class="site_title"><i class="fa fa-user"></i> <span style="font-size:15px;">Super Administrator</span></a>
                    </div>
                    <div class="clearfix"></div>
                    <!-- menu profile quick info -->
                    <div class="profile clearfix" style="background-color:darkolivegreen;">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="<?php echo base_url('SuperAdmin') ?>"><i class="fa fa-home"></i> Beranda </a></li>
                                <li><a href="<?php echo base_url('SuperAdmin/kelolaUser') ?>"><i class="fa fa-list-alt"></i> Kelola Pengguna </a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /sidebar menu -->
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                    <span class="fa fa-user"></span> <?php echo $this->session->userdata('first_name') . ' ' . $this->session->userdata('last_name'); ?>
                                </a>
            ...
            <div class="right_col" role="main">
                ...
                <?php include 'pages_super_admin/' . $pageName . '.php'; ?>
            </div>
            <!-- /page content -->
